...
function addDiaries(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    map.addInteractiveLayer('diaries', diaries, {

        // The display name for this layer
        name: 'John Morgan\'s Diary Entries',
        ...
        sidebar_icon_html: '<i class="fas fa-book"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-book'),
                riseOnHover: true
            });
        }
    });
