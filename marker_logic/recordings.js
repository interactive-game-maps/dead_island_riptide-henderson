...
function addRecordings(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    map.addInteractiveLayer('recordings', recordings, {

        // The display name for this layer
        name: 'Voice Recordings of Angela Guerra',
        ...
        sidebar_icon_html: '<i class="fas fa-microphone"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-microphone'),
                riseOnHover: true
            });
        }
    });
