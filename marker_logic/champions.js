...
function addChampions(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    map.addInteractiveLayer('champions', champions, {

        // The display name for this layer
        name: 'Champion Monsters',
        ...
        sidebar_icon_html: '<i class="fas fa-skull"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-skull'),
                riseOnHover: true
            });
        }
    });
