...
function addPostcards(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    map.addInteractiveLayer('postcards', postcards, {

        // The display name for this layer
        name: 'Postcards from Palanai',
        ...
        sidebar_icon_html: '<i class="fas fa-envelope"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-envelope'),
                riseOnHover: true
            });
        }
    });
